...
<head>
    ...
    <title>Tạo sản phẩm mới | Hệ thống quản lý</title>
                ...
                <div class="card">
                    <div class="card-header py-3 d-flex justify-content-between align-items-center">
                        <h4 class="m-0 font-weight-bold">
                            <i class="bi bi-plus-circle me-2"></i>Tạo sản phẩm mới
                        </h4>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <img id="preview" class="preview-image img-thumbnail mt-2" src="#" alt="Preview" />
                            </div>
                            
                            <div class="mb-4">
                                <label for="description" class="form-label">Mô tả sản phẩm</label>
                                <textarea name="description" id="description" class="form-control" rows="4" placeholder="Nhập mô tả chi tiết về sản phẩm..."></textarea>
                            </div>
